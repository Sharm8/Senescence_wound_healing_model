...
#sys.path.insert(0,'/mnt/nfs/home/b6002514/.local/lib/python3.7/site-packages/slurmpy') # since slurmpy is installed locally
...
cc3dPath   = '/u/jsluka/CC3D_425/425/install/runScript.sh'  # full path to the CC3D run script

Quality_data_file_name = '' # full path plus file name "Quality_data.txt"
projectPath= '/u/jsluka/swarm/'       #'/u/jsluka/swarm/'  # the command above isn't getting the path!
print("projectPath: ",projectPath)
#cc3dJobName = 'PSO_cell_sort_test.cc3d'  # *.cc3d file name, could be obtained using the projectPath
cc3dJobName = 'Wound_healing_Main.cc3d'#'/mnt/nfs/home/b6002514/20Aug2021jps/Wound_healing_Main.cc3d'   # *.cc3d file name, could be obtained using the projectPath
#cc3dParameterFile = 'PSO_cell_sort_testParameters.py'  # *_parameters.py, this file lives in the CC3D project's "Simulation" folder
cc3dParameterFile = 'Parameters_WH.py'  #/mnt/nfs/home/b6002514/20Aug2021jps/Simulation/Parameters_WH.py'  # *_parameters.py, this file lives in the CC3D project's "Simulation" folder
#theUserID = 'jsluka'  # not needed since this script automatically gets the user's ID
writeRunningFileTo = '/u/jsluka/swarm/swarm_running_result.txt'  #'/u/jsluka/swarm/swarm_running_result.txt'  # where the running log summary file is written
writeFinalFileTo   = '/u/jsluka/swarm/swarm_final_result.txt' #'/u/jsluka/swarm/swarm_final_result.txt'  # where the final summary file is written
slurm_scripts_dir = '/u/jsluka/swarm/slurm-scripts/'
####################################################################################
...
def main():
    ...
    writeFinalFileTo   = projectPath+'swarm_final_result_old.txt'  #'/u/jsluka/swarm/swarm_final_result_OLD.txt'  # where the final summary file is written
